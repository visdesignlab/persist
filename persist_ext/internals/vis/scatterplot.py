...
from persist_ext.internals.layout.widget import TrrackableOutputLayout
...
def scatterplot(
    data, x, y, color=None, circle=False, interaction=True, selection_type="interval"
):
    """
    Args:
    ...
    return TrrackableOutputLayout(VegaLiteChartWidget(chart))
